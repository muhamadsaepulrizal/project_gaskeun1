...
<div class="page-header flex items-center justify-between">
    <div>
        ...
        <h1 class="page-title">Tambah Data Petani</h1>
    </div>
...
<div class="card p-8 max-w-xl">
    <form action="{{ route('disperindag.petanis.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="number" name="luas_lahan_m2" required class="input-field mt-1" placeholder="Contoh: 1000">
        ...
        <div>
            ...
            <input type="text" name="jenis_komoditas" required class="input-field mt-1" placeholder="Contoh: Padi, Jagung">
